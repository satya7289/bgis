 ...
 *    Image will be cropped to the specified dimensions within the defined crop area.
...
function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {
	...
	/*
	 * Image that have been edited in WordPress after being uploaded will
...
function wp_enqueue_media( $args = array() ) {
	...
	$strings = array(
		...
		'uploadImagesTitle'           => __( 'Upload Image' ),
