...
function wp_image_editor( $post_id, $msg = false ) {
	...
	<div class="imgedit-group-top">
		...
		<p><?php _e( 'You can proportionally scale the original image. For best results, scaling should be done before you crop, flip, or rotate. Image can only be scaled down, not up.' ); ?></p>
		</div>
