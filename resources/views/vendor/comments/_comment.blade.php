...
@endif
    <div class="media-body">
        <h5 class="mt-0 mb-1" style="color:brown;"><span style="text-decoration:underline">{{$comment->commenter->name }} </span><small class="text-muted">- {{ $comment->created_at->diffForHumans() }}</small></h5>
        <div style="white-space: pre-wrap;" style="color:black"><p style="color:black">{!! $markdown->line($comment->comment) !!}</div>
