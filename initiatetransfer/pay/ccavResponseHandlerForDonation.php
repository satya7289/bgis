...
<?php
	...
	$workingKey='CA9306E33CA82A11CF1D96DE77B03994';		//Working Key should be provided here.
	...
	for($i = 0; $i < $dataSize; $i++)
	{
		...
		/*if($i==2) $two			=	$information[1] ;
		if($i==4) $four				=	$information[1] ;
		if($i==6) $six				=	$information[1] ;
		if($i==7) $seven			=	$information[1] ;
		if($i==8) $eight			=	$information[1] ;
		if($i==9) $nine				=	$information[1] ;
		if($i==12) $twelve			=	$information[1] ;
		if($i==14) $fourteen		=	$information[1] ;
		if($i==15) $fivteen			=	$information[1] ;

		if($i==19) $nineteen		=	$information[1] ;
		if($i==20) $twenty			=	$information[1] ;
		if($i==21) $twentyone		=	$information[1] ;
		if($i==22) $twentytwo		=	$information[1] ;
		if($i==23) $twentythree		=	$information[1] ;
		if($i==24) $twentyfour		=	$information[1] ;
		if($i==25) $twentyfive		=	$information[1] ;
		if($i==26) $twentysix		=	$information[1] ;
		if($i==27) $twentyseven		=	$information[1] ;
		if($i==28) $twentyeight		=	$information[1] ;
		if($i==29) $twentynine		=	$information[1] ;
		if($i==30) $thirten			=	$information[1] ;
		if($i==31) $thirtenone		=	$information[1] ;
		if($i==32) $thirtentwo		=	$information[1] ;
		if($i==33) $thirtenthree	=	$information[1] ;
		if($i==34) $thirtenfour		=	$information[1] ;
		if($i==35) $thirtenfive		=	$information[1] ;
		if($i==36) $thirtensix		=	$information[1] ;
		if($i==37) $thirtenseven	=	$information[1] ;
		if($i==38) $thirteneight	=	$information[1] ;
		if($i==39) $thirtennine		=	$information[1] ;
	*/
		...
		if($i==13) $billing_address	=	$information[1] ;
	...
	/*	echo "<table><tr><td>".
		 ...
		 $nine ."</td></tr><tr><td>".
		 $twelve ."</td></tr><tr><td>".
		 $fourteen ."</td></tr><tr><td>".
		 $fivteen ."</td></tr><tr><td>".
		 $sixteen ."</td></tr><tr><td>".
		 $nineteen ."</td></tr><tr><td>".
		 $twenty ."</td></tr><tr><td>".
		 $twentyone ."</td></tr><tr><td>".
		 $twentytwo ."</td></tr><tr><td>".
		 $twentythree ."</td></tr><tr><td>".
		 $twentyfour ."</td></tr><tr><td>".
		 $twentyfive ."</td></tr><tr><td>".
		 $twentysix ."</td></tr><tr><td>".
		 $twentyseven ."</td></tr><tr><td>".
		 $twentyeight ."</td></tr><tr><td>".
		 $twentynine ."</td></tr><tr><td>".
		 $thirten ."</td></tr><tr><td>".
		 $thirtenone ."</td></tr><tr><td>".
		 $thirtentwo ."</td></tr><tr><td>".
		 $thirtenthree ."</td></tr><tr><td>".
		 $thirtenfour ."</td></tr><tr><td>".
		 $thirtenfive ."</td></tr><tr><td>".
		 $thirtensix ."</td></tr><tr><td>".
		 $thirtenseven ."</td></tr><tr><td>".
		 $thirteneight ."</td></tr><tr><td>".
		 $order_id."</td></tr><tr><td>".
		 $tracking_id."</td></tr><tr><td>".
		 $order_status."</td></tr><tr><td>".
		 $payment_mode."</td></tr><tr><td>".
		 $amount."</td></tr><tr><td>".
		 $billing_name."</td></tr><tr><td>".
		 $billing_address."</td></tr><tr><td>".
		 $billing_tel."</td></tr><tr><td>".
		 $billing_email."</td></tr><tr><td>".
		 $trans_date."</td></tr><tr><td>".
		 $thirtennine ."</td></tr><tr><td></table>";*/


	$to = "ananta.bcs@gmail.com";
	$subject = "CONTRIBUTE FOR BGIS NEW PROJECT !! ";
...
India<br>Email: <a href='mailto:info@newbgis.org' class='m_2109585722555529806hylink2' style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737;text-decoration:underline' target='_blank'>info@newbgis.org</a> <br>Website: <a href='http://www.newbgis.org/' class='m_2109585722555529806hylink2' style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737;text-decoration:underline' target='_blank' data-saferedirecturl='https://www.google.com/url?hl=en&amp;q=http://www.ccavenue.com/&amp;source=gmail&amp;ust=1520745983794000&amp;usg=AFQjCNE8rf71lXG7alhQFCr9wUXO9ptPtA'>www.newbgis.org</a> <br> Phone : +91-7088004339</td><td width='26%' align='right' valign='bottom'><img src='https://ci6.googleusercontent.com/proxy/yYoAcFnxccSJ2jUQrxQTZwRafKwXd3px5H32BjN_esypKR53uAl8ve3mGF8QcM0D0ZHtmryxX_Th8vhrAXoUSCD63Wk4ArYhdNslIaQ_8Cd6huem3Ip3YRDQwDT6h8j2rwIjwQFtmQ=s0-d-e1-ft#https://dashboard.ccavenue.com/ImgStore/Image/50225_GtwSetlogo_1516705188477.png' width='109' height='85px' border='0' class='CToWUd'> </td></tr></tbody> </table> </td></tr></tbody> </table> </td></tr></tbody></table>";
	...
	//$messages = "<div class='container' style='margin: 5%'><div class='row'><div class='well col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-3'><div class='row'><table class='table'><tr><th><img src='http://bgis.org/img/logo.png'> </th><td> <h5> Receipt No #  $order_id </h5> <p> <em>Date:  $trans_date </em></p><address><p><b>Bhaktivedanta Gurukula and International School</b><br>Bhaktivedanta Swami Marg,<br>Raman Reti, Vrindavan, Mathura<br>Uttar Pradesh, 281121<br>India<br></p></address> </td></tr><tr><td colspan='2'><div><h3>Transaction No # : $tracking_id <br>Contribute Status :  $order_status  </h3></div></td></tr><tr><td colspan='2'><div><h3> $message  </h3></div> </td></tr><tr> <td colspan='2'> <h4>Dear $billing_name ,</h4><ul><li>Receipt No : $order_id</li><li>Transaction No : $tracking_id</li><li>Status : $order_status</li><li>Payment Type : $payment_mode</li><li>Name : $billing_name</li><li>Mobile No : $billing_tel</li><li>Email ID : $billing_email</li><li><b>Amount : $amount</b></li></ul></td></tr> </table> </div></div></div>";
		...
		$username = "root";
		$password = "";
		$dbname = "bgis_online_payment_details";
		$conn = mysqli_connect($servername, $username, $password, $dbname);

		$sql = "INSERT INTO online_adminssion_payment (
		id, 
		billing_name, 
		order_id, 
		tracking_id, 
...
Raman Reti,<br> Vrindavan - 281121, U.P.
India<br>Email: <a href='mailto:info@newbgis.org' class='m_2109585722555529806hylink2' style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737;text-decoration:underline' target='_blank'>info@newbgis.org</a> <br>Website: <a href='http://www.newbgis.org/' class='m_2109585722555529806hylink2' style='font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#373737;text-decoration:underline' target='_blank' data-saferedirecturl='https://www.google.com/url?hl=en&amp;q=http://www.ccavenue.com/&amp;source=gmail&amp;ust=1520745983794000&amp;usg=AFQjCNE8rf71lXG7alhQFCr9wUXO9ptPtA'>www.newbgis.org</a><br> Phone : +91-7088004339</td><td width='26%' align='right' valign='bottom'><img src='https://ci6.googleusercontent.com/proxy/yYoAcFnxccSJ2jUQrxQTZwRafKwXd3px5H32BjN_esypKR53uAl8ve3mGF8QcM0D0ZHtmryxX_Th8vhrAXoUSCD63Wk4ArYhdNslIaQ_8Cd6huem3Ip3YRDQwDT6h8j2rwIjwQFtmQ=s0-d-e1-ft#https://dashboard.ccavenue.com/ImgStore/Images/50225_GtwSetlogo_1516705188477.png' width='109' height='85px' border='0' class='CToWUd'> </td></tr></tbody> </table> </td></tr></tbody> </table> </td></tr><tr><td> <button onclick="window.print();" class="btn btn-primary"> PRINT PAGE</button>  <br>Redirect after 20 second...<br><progress value="0" max="20" id="progressBar"></progress></td></tr></tbody></table>
