  						...
  						<div class="hg_accordion_element style5">							 
							...
							<div class="th-accordion">
								...
								<a href="<?=base_url()?>create-excel-for-admissions">Export Report Excel</a>
									...
									<div class="acc-group">
										...
										<div id="heading<?= ++$key ?>">
											...
											<a data-toggle="collapse" data-number="<?= $key ?>" data-target="#acc<?= $key ?>" class="collapsed" aria-expanded="false" aria-controls="acc1">
												...
												<div class="row" style="font-weight: 700; font-size: 10px">

													<div class="col-md-3" style="font-size: 14px"> <?= $admission->tracking_id ?> </div>

													<div class="col-md-4"><?= str_replace('_',' ', $admission->billing_name)  ?></div>

													<div class="col-md-2"><?= $admission->order_status ?></div> 

											 &nbsp; <div class="col-md-2"><?= $admission->amount ?></div>
											...
											<div class="content"  style="font-size: 10px">
												...
												<table width="100%">	
													...
													<tr>
														...
														<th>Admission Date : </th><td> <?= $admission->admission_date ?></td>
													...
													<tr>
														...
														<th>Payment Date</th><td> <?= $admission->trans_date ?></td>
