...
<input type="hidden" name="Title" value="PHP VPC 3-Party">
  ...
  <table width="80%" align="center" border="0" cellpadding='0' cellspacing='0'>
    ...
    <tr bgcolor="#C1C1C1"> 
      <td colspan="3">
<p><b>&nbsp;Thank you for choosing Domestic 
          Payment </b></p></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
      <td><input type="Hidden" name="vpc_AccessCode" value="C89291BC" size="20" maxlength="8"></td>
    </tr>
    <tr bgcolor="#E1E1E1"> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
      <td><input type="Hidden" name="vpc_MerchTxnRef" value="DOMRAMA" size="" maxlength="40"></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td align="right"><b><i></i></b></td>
      <td><input type="Hidden" name="vpc_Merchant" value="GURUKULA" size="20" maxlength="16"></td>
    </tr>
    <tr bgcolor="#E1E1E1"> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td align="right"><b><i>Please confirm the amount (Rs.)</i></b></td>
      <td><input type="text" name="vpc_Amount" value=" <?php echo $amount; ?>" size="20" maxlength="10" ></td>
    </tr>
    <tr bgcolor="#E1E1E1"> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
    <td><input type="Hidden" name="vpc_ReturnURL" size="63" value="http://bgis.org/vpc/vpc_php_serverhost_dr.php?user_name=<?php echo "$username";?>&id_user=<?php echo "$user_id";?>" maxlength="250"></td>
    </tr>
    <tr> 
      <td colspan="3">&nbsp;</td>
    </tr>
    ...
    <tr> 
      <td colspan="3">
      <div align="center" style="position: relative;margin-top: -45px;margin-bottom: 35px; font-size: 15px;font-weight: bold;">&nbsp; (When you click on 'Pay Now! 
          button, the amount is converted to paise) </div>
        &nbsp;</td>
    </tr>
    <tr bgcolor="#C1C1C1"> 
      <td>&nbsp;</td>
