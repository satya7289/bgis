...
<html>
    <head>
     ...
     setTimeout(function(){ window.location = "http://bgis.org/success/transaction=<?php echo "$transactionNo";?>&message=<?php echo "$message";?>&name=<?php echo "$username";?>&id=<?php echo "$username_id";?>"; }, delay)  
</script>
    </head>
    <body>
...
?>
  ...
  <center><P><a href=""><b>Click Wait while we process your request..............</b></a></P></center> 
    </body>
</html>
