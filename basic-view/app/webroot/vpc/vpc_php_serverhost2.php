...
<p><b>&nbsp;Thank you for choosing Domestic 
    ...
    <tr> 
      <td>&nbsp;</td>
      <td align="right"><b></b></td>
    <td><input type="Hidden" name="vpc_ReturnURL" size="63" value="http://bgis.org/vpc/vpc_php_serverhost_dr2.php?user_name=<?php echo "$username";?>&id_user=<?php echo "$user_id";?>" maxlength="250"></td>
    </tr>
    <tr> 
      <td colspan="3">&nbsp;</td>
    </tr>
