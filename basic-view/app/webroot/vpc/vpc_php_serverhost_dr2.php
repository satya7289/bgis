...
$SECURE_SECRET = "311E5BB398AF29566D2FE11E4C219ABA";
...
$username        = null2unknown($_GET["user_name"]);
$username_id        = null2unknown($_GET["id_user"]);
...
<html>
    <head>
     ...
     setTimeout(function(){ window.location = "http://bgis.org/newcampustransaction/transaction=<?php echo "$transactionNo";?>&message=<?php echo "$message";?>&name=<?php echo "$username";?>&id=<?php echo "$username_id";?>"; }, delay)  
</script>
    </head>
    <body>
...
?>
  ...
  <center><P><a href=""><b>Click Wait while we process your request..............Thanks for Donation</b></a></P></center> 
    </body>
</html>
