...
<?php         include("login.php");
			...
			mysql_select_db($db_database)
			    or die("Unable to select database: " . mysql_error());
                    ...
                    $rs1=mysql_query($sql="UPDATE donation SET payment_status = 'Aborted' WHERE id = '".$pmt_orderId."' ");				      
		  $to = 'mansi@maatti.com' ;
...
<div class=" pro_main" style="font-size:18px;  color:#C00 ; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; padding-top:20px; padding-bottom:20px;" >
  <div class="hd7"  style=" background:#CC0000; font-size:28px; font-family: Geneva, Arial, Helvetica, sans-serif; color:#FFFFFF; width:130px; border: 2px solid #FFFFFF ; margin-left:170px; " >&nbsp;&nbsp;Aborted</div> 
<div class="pro_left">
