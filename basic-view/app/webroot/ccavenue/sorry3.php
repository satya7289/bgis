...
<?php            include("login.php");
			...
			mysql_select_db($db_database)
              ...
              $rs1=mysql_query($sql="UPDATE donation SET payment_status = 'Security Error' WHERE id = '".$pmt_orderId."' ");					          		      
				        $to = 'mansi@maatti.com' ;
...
<div class=" pro_main" style="font-size:18px;  color:#C00 ; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; padding-top:20px; padding-bottom:20px;" >
  <div class="hd7"  style=" background:#CC0000; font-size:28px; font-family: Geneva, Arial, Helvetica, sans-serif; color:#FFFFFF; width:130px; border: 2px solid #FFFFFF ; margin-left:170px; " >&nbsp;&nbsp;Security Error. Illegal access detected</div> 
<div class="pro_left">
  <p style="text-align:center;">"Thank you for Donating ISCKON  School Project.We will keep you posted regarding the status of your Donation through e-mail";<br/> <strong style="color: #000"> Your Tracking ID is :</strong> <?php echo $tracking_id; ?></p>
