   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
               <ul>
                <h1>News & events</h1>
					...
					<li><a href="/competition3" >Mission: Clean Virndavan</a></li>
			               ...
			               <li><a href="/championship" class="active" >Swimming Champions 2014</a></li>
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>Events</h1>
         <h2 style="color:#656567;">Swimming Champions 2014, yet again!</h2>
          <br/>
         <div class="imagezoom">
              <p>
		<a class="fancybox" href="demo/21_b.jpg" data-fancybox-group="gallery" ><img src="demo/21_s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/22_b.jpg" data-fancybox-group="gallery" ><img src="demo/22_s.jpg" alt="" /></a>
        	<a class="fancybox" href="demo/23_b.jpg" data-fancybox-group="gallery" ><img src="demo/23_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/24_b.jpg" data-fancybox-group="gallery" ><img src="demo/24_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/25_b.jpg" data-fancybox-group="gallery" ><img src="demo/25_s.jpg" alt="" /></a>
	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">Students of Bhaktivedanta Gurukula were declared the swimming champions at the district inter school swimming championship 2014.  Our boys have been consistently winning medals for the last 12 years.  This year BGIS also won the"overall Championship" cup, adding one more feather in their cap.  Our students totally bagged 10 golds and 2 silvers.</p>
         <div class="down">&nbsp;</div>
          <p style="margin-left:10px;">Gagan Puri, of class 12, was awarded the best swimmer award among the 10-12 schools which participated in the event.  The management of the school congratulates the winners and extends special thanks to the coach Mr. Yogesh Yadav.</p>
