   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">PRIZE GIVING DAY</h2>
          <br/>
         <div class="imagezoom">
              <p>
<a class="fancybox" href="img/prize/01.jpg" data-fancybox-group="gallery" ><img src="img/prize/01.jpg" alt="" style="width: 233px;height: 160px;"/></a>

<a class="fancybox" href="img/prize/02.jpg" data-fancybox-group="gallery" ><img src="img/prize/02.jpg" alt="" style="width: 233px;height: 160px;" /></a>

<a class="fancybox" href="img/prize/03.jpg" data-fancybox-group="gallery" ><img src="img/prize/03.jpg" alt="" style="width: 233px;height: 160px;"/></a>

<a class="fancybox" href="img/prize/04.jpg" data-fancybox-group="gallery" ><img src="img/prize/04.jpg" alt="" style="width: 233px;height: 160px;"/></a>

<a class="fancybox" href="img/prize/05.jpg" data-fancybox-group="gallery" ><img src="img/prize/05.jpg" alt="" style="width: 233px;height: 160px;" /></a>
        ...
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">The Bhaktivedanta Gurukula and International School - Vrindavan held its Annual prize giving day on 29th August 2017 on the very auspicious day of Radhashtami the appearance day of Srimati Radharani.  The event started with a sweet harinam sankirtan led by the team of Sanjay Prabhu. The students were blessed by the presence of H.H. Bhakti Gaurav Narayan Maharaj. Maharaj gave a wonderful class in glorification of Srimati Radharani . Maharaj revealed the mystery of the appearance of Radharani in this world. After the class, Maharaj presided over the awarding of certificates to different students who excelled in academics. He also handed over the plaques for those who won the drawing and painting competition and English writing composition. We congratulate all the students who did a wonderful job and to all the teachers who never goes tired for keeping gurukula boys to be the finest. May Srimati Radharani bestow her mercy upon us. Jai Jai Sri Radhe!
