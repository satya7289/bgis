   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">1st Prize in Drawing Competition </h2>
          <br/>
         <div class="imagezoom">
              <p>
		<a class="fancybox" href="demo/news-l.jpg" data-fancybox-group="gallery" ><img src="demo/news-s.jpg" alt="" /></a>
	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">A drawing competition was conducted by archaeological department  of Madhan Mohan Ji Temple, Vrindavan., One of the ancient temples of Vrindavan of Srila Sanata Goswami.  Many schools such as Bhaktivedanta Gurukul, Govinda Dev School, Haridas Bal Shikshayatan, Nimbark Shishu Mandir, and many other school took part in the art competition.  Ladoo Gopal of BGIS of class 6 won won the first prize.  The school congratulates Ladoo Gopal for his achievement and bringing credit to the school.   
</p>
         <div class="down">&nbsp;</div>
