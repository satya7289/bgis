   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
               <ul>
                <h1>News & events</h1>
			              <ul>
			               ...
			               <li><a href="//gita-jayanti" class="active">Gita Jayanti.</a></li>
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">Gita Jayanti Honoured at Bhaktivedanta Gurukula </h2>
          <br/>
         <div class="imagezoom">
              <p>
...
<a class="fancybox" href="img/gita-jayanti-2017/005.jpg" data-fancybox-group="gallery" ><img src="img/gita-jayanti-2017/005.jpg" alt="" style="width: 233px;height: 160px;"/></a>
	       ...
	       <p>Students and staff of Gurukula celebrated the auspicious Gita Jayanti on 30th November 2017.  Almost 5000 years ago Bhagavan Sri Krishna spoke this wonderful Gita to His friend and disciple Arjuna.  Bhagavat Gita is the essence of all Vedic Knowledge.  In 700 verses the Lord reveals Isvara (Lord), Jiva (Living Entity), Kala (Time which includes the three modes of nature), Karma (Our actions) & Prakriti (Nature) the five primary subjects in the Gita.  </p><p>

Sri Arjuna is representing a lost soul bewildered in executing his duties, where Sri Krishna reveals the Soul's / Jiva's eternal relationship with Him and explains how by connecting to the Purusha, the supreme Lord the Jiva, the living entity can revive his lost consciousness and can be eternally happy.</p><p>

Students from class 2 till 12 chanted the holy verses in groups.  Also teachers and staff joined in chanting few chapters of the Gita. Gita recitation competition were conducted in school at various levels on the previous days to encourage the children to memorise and understand the meaning of Gita. </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
