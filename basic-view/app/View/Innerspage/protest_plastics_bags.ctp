...
<div class="bannerinner">
   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
               <ul>
                <h1>News & events</h1>
				       ...
				       <li><a href="/competition3" >Mission: Clean Virndavan</a></li>
			               ...
			               <li><a href="/competition" class="active" >1st Prize in Drawing Competition</a></li>  
         ...
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567; text-transform: uppercase; ">Vraj free from "plastics. Plastic bags</h2>
          <br/>
         <div class="imagezoom">
              <p>
 
<a class="fancybox" href="img/plastics-bags/plastics.jpg" data-fancybox-group="gallery" ><img src="img/plastics-bags/plastics.jpg" alt="" style="width: 233px;height: 160px;" /></a>

 
<a class="fancybox" href="img/plastics-bags/plastics-1.jpg" data-fancybox-group="gallery" ><img src="img/plastics-bags/plastics-1.jpg" alt="" style="width: 233px;height: 160px;"/></a>

<a class="fancybox" href="img/plastics-bags/plastics-2.jpg" data-fancybox-group="gallery" ><img src="img/plastics-bags/plastics-2.jpg" alt="" style="width: 233px;height: 160px;"/></a>
        ...
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">Students of Bhaktivedanta Gurukula participated in social awareness event on 10th November 2017.  Students went on a human chain to request the residents and visitors to Vrindavan to keep our beloved Vraj free from "plastics.   Plastic bags tend to disrupt the environment in a serious way. They get into soil and slowly release toxic chemicals. They eventually break down into the soil, with the unfortunate consequence being that animals eat them and often choke and die. <br><br>

Students stood on human chain on the parikrama marg along with hundreds of other school children to request all to refrain from this hazardous material called PLASTIC.
         <div class="down">&nbsp;</div>
