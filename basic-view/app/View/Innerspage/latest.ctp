   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>BGIS Latest News</h1>
         <h2 style="color:#656567;">Bhaktivedanta Gurukula & International School invites applications for teaching positions</h2>
          <br/>
         <div class="imagezoom">
              <!--p>
		<a class="fancybox" href="img/miland/pic1.jpg" data-fancybox-group="gallery" ><img src="img/miland/pic1.jpg" alt="" style="width: 233px;height: 160px;" /></a>
		<a class="fancybox" href="img/miland/pic2.jpg" data-fancybox-group="gallery" ><img src="img/miland/pic2.jpg" alt="" style="width: 233px;height: 160px;" /></a>
		<a class="fancybox" href="img/miland/pic3.jpg" data-fancybox-group="gallery" ><img src="img/miland/pic3.jpg" alt=""  style="width: 233px;height: 160px;"/></a>
	       </p-->
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">Bhaktivedanta Gurukula & International School, Vrindavan founded by HDG A.C.Bhaktivedanta Swami Srila Prabhupada, which is affiliated with ICSE / ISC board has 280 students studying currently from various parts of India and abroad.  The school will soon shift to a new campus of 60 acres located in the lush green lands of Vrindavan.  It shall have world class amenities.</p>
        <p style="margin-left:10px;">We are seeking applications from qualified teachers for the following subjects:  </p>
	...
	<p style="margin-left:10px;">Remuneration will be based on qualification and experience.  <br>

	Please send your resume to "bgis.services@gmail.com" <br><br>
