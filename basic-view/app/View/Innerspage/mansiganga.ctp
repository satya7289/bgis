      ...
      <div class="leftsidemenu">
               ...
               <li><a href="/latest">Latest News</a></li>
					...
					<li><a href="/competition3" >Mission: Clean Virndavan</a></li>
				       ...
				       <li><a href="/mansiganga" class="active" >Mansi Ganga Innaguration</a></li>
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>Events</h1>
         <h2 style="color:#656567;">Mansi Ganga Inauguration</h2>
          <br/>
         <div class="imagezoom">
              <p>
		<a class="fancybox" href="demo/9_b.jpg" data-fancybox-group="gallery" ><img src="demo/9_s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/10_b.jpg" data-fancybox-group="gallery" ><img src="demo/10_s.jpg" alt="" /></a>
        	<a class="fancybox" href="demo/11_b.jpg" data-fancybox-group="gallery" ><img src="demo/11_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/12_b.jpg" data-fancybox-group="gallery" ><img src="demo/12_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/13_b.jpg" data-fancybox-group="gallery" ><img src="demo/13_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/14_b.jpg" data-fancybox-group="gallery" ><img src="demo/14_s.jpg" alt="" /></a>
	        <a class="fancybox" href="demo/15_b.jpg" data-fancybox-group="gallery" ><img src="demo/15_s.jpg" alt="" /></a>	
	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">On 9th July, 2014 there was inauguration of a new kunda (pond) which was named Mansi Ganga. This will be part of the upcoming Vrindranyam botanical garden in the new BGIS campus in which we will recreate the forest of Vrindavan. The inauguration was done by HG Lila Purushottam prabhu, Direcor, BGIS, with estactic kirtan. The gurukula boys helped in laying the stones to beautify the pond and later had great fun by bathing and swimming in the pond.</p>
         <div class="down">&nbsp;</div>
