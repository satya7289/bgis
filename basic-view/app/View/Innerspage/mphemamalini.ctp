   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
                ...
                <h1>News & events</h1>
				      ...
				      <li><a href="/competition3">Mission: Clean Virndavan</a></li>
			              ...
			              <li><a href="/competition2">Gita Jayanti celebrated in BGIS</a></li>
			               ...
			               <li><a href="/mphemamalini" class="active" >MP Hemamalini visits Bhaktivedanta Gurukul</a></li>
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>Events</h1>
         <h2 style="color:#656567;">MP Hemamalini visits Bhaktivedanta Gurukul</h2>
          <br/>
         <div class="imagezoom">
              <p>
		<a class="fancybox" href="demo/hemamalini4.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini4-s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/hemamalini3.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini3-s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/hemamalini6.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini6-s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/hemamalini2.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini2-s.jpg" alt="" /></a>
		<a class="fancybox" href="demo/hemamalini1.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini1-s.jpg" alt="" /></a>
        	<a class="fancybox" href="demo/hemamalini5.jpg" data-fancybox-group="gallery" ><img src="demo/hemamalini5-s.jpg" alt="" /></a>
	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">Former actress and current Member of Parliament of Mathura Ms.Hemamalini visited Gurukul on 18th October 2014.  She was invited by our director Lila Purushotham Das during his meeting with her in Kanpur.  She was delighted to be present in Gurukul.  In her address to the school she said, "I am also Krishna's devotee and I have been given chance to perform  seva in Vraja. I will be happy to do service for the school." She also added, "You children are very fortunate to study here in Vraja. You should propagate Vedic culture throughout the world spreading the message of Srila Prabhupada and in his glorification." </p>
         <div class="down">&nbsp;</div>
          <p style="margin-left:10px;">The director of BGIS gave a brief power point presentation about the structure and vision of the new 60 acre project of the upcoming gurukula.  The program was presided over by the president of ISKCON, Vrindavan HG Panchagauda Prabhu, and other senior Vaishnavas.  </p>
