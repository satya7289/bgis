   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">BGIS conducted a 2 day seminar on Bharat Gurukula Shiksha Abhiyana "The Collapse of Education is the Collapse of the Culture & Nation"</h2>
          <br/>
         <div class="imagezoom">
              <!--p>
...
<a class="fancybox" href="demo/cml6.jpg" data-fancybox-group="gallery" ><img src="demo/cms6.jpg" alt="" style="width: 233px;height: 160px;"/></a>
        ...
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">The two day seminar was conducted on October 16th & 17th, 2017 by Acharya Shri Mehul Bhai Ji who has vast years of experience in training students in the traditional Gurukula education.  The seminar was attended by both school teachers and people from other cities of India.  It was a very practical session Mehul bhai Ji explaining the current plight of education and what actually education means and how to mould the child to become a perfect human being as enjoined in the Vedic Shastras. 
