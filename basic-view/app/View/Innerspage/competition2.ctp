   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">10th graders begin their board preparation with grand Abhishek</h2>
          <br/>
         <div class="imagezoom">
              <p>
<a class="fancybox" href="img/abhishek-2017/abhishek1.JPG" data-fancybox-group="gallery" ><img src="img/abhishek-2017/abhishek1.JPG" alt="" style="width: 233px;height: 160px;"/></a>
<a class="fancybox" href="img/abhishek-2017/abhishek2.JPG" data-fancybox-group="gallery" ><img src="img/abhishek-2017/abhishek2.JPG" alt="" style="width: 233px;height: 160px;" /></a>
<a class="fancybox" href="img/abhishek-2017/abhishek3.JPG" data-fancybox-group="gallery" ><img src="img/abhishek-2017/abhishek3.JPG" alt="" style="width: 233px;height: 160px;"/></a> 

	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">The students of 10th grade began their board preparation by honouring the Deities with Maha Abhishek on 4th March 2017.  Students enthusiastically organised a nice abhishek for their beloved ashram Deities Sri Sri Gaura Nitai on that day.  Teachers and staff were invited to grace the occasion.  The program began as usual as per Gurukula tradition with kirtan greeting Guru, Acharyas and the Lord following colourful abhishek with milk, curd, honey, sugar syrup and various colourful fruit juices.  		
