   ...
   <div class="down">&nbsp;</div>
      ...
      <div class="leftsidemenu">
        ...
        <div class="rightsidecontent">  
         <div class="aboutus">
         <h1>News & Events</h1>
         <h2 style="color:#656567;">The students of BGIS have once again brought laurels for the school by their excellent performance in ICSE and ISC examinations 2015.	</h2>
          <br/>
         <div class="imagezoom">
              <p>
<a class="fancybox" href="demo/Ashwin.jpg" data-fancybox-group="gallery" ><img src="demo/ashwin_small.jpg" alt=""  style="width: 233px;height: 160px;" /></a>
<a class="fancybox" href="demo/bgis_news.jpg" data-fancybox-group="gallery" ><img src="demo/bgis_news.jpg" alt="" style="width: 233px;height: 160px;" /></a>

	       </p>
          </div>
        </div>
        <div class="down">&nbsp;</div>
        <p style="margin-left:10px;">The Council for the Indian Secondary Certificate of Education (CISCE) released their final exam results recently and Bhaktivedanta Gurukula and International School (BGIS) students in the 10th and 12th grade had a 100% pass rate.
Ashwin Bhusan Bhat , who graduated from 12th grade, was Second in the Mathura district in the highly-competitive science stream with 96.5% overall average.
Three students of class 10 namely Devansh Agarwal, Sandesh Sikarwar and Kartikay Goswami got 100% marks in Commerce.
<br/>
</p>
<span style="margin-left:25px;"><b>Some of the highlights of the results :</b></span>
<br/>
<ul style="margin-left:25px;">
<li>Ashwin Bhusan Bhat of class 12 topped ISC with aggregate of 96.5 % marks, which is the second highest in Mathura District.</li>
<li>Devrat Wagle of class 10 topped ICSE with aggregate of 94.2%..</li>
<li>Three students of class 10 namely Devansh Agarwal, Sandesh Sikarwar and Kartikay Goswami got 100% marks in Commerce.</li>
<li>The average score obtained by the students in Computer Science in class 10 is 97.75 % and in class 12 is 97.2 %.</li>
</ul>
<br/>
<p style="margin-left:25px;">The results have been remarkably good this year and have set new records for BGIS and Mathura District. 
All credit goes to the sincere efforts by the students and teachers. Dhruv Singhal, the topper in the ISC Commerce stream got 95% marks in Economics. 
Students at BGIS are excelling in both academics and spirituality will fulfill its vision to create leaders of the society with character and competence.		  
</p>
         <div class="down">&nbsp;</div>
