	...
	<div class="container">
        <div class="section">
            <div class="section-header">
              <h3>Add a New Contribute Page</h3>
                <div class="section-actions" style="margin-top: 8px;">
          <?php echo $this->Html->link(__('List Contribute Page'), array('action' => 'index'),array( "class"=>"btn btn-primary")); ?>
                </div>
            </div>
            ...
            <?php echo $this->Form->create('Contribute',array('enctype'=>"multipart/form-data"));?>
                <fieldset class="inputs">
                    <legend><?php __('Add Contribute Page'); ?></legend>
                ...
                <br/>
                    ...
                    <span class="add-on"><i class="icon-book"></i>&nbsp; Page Title</span>
                      <input  name="data[Contribute][page_title]" type="text" placeholder="">
                </div>
                <br/>
                <br/>
                    <div class="input-prepend">
                    <span class="add-on"><i class="icon-book"></i>&nbsp; Banner Image</span>
                      <input  type="file"  name="data[Contribute][banner_image]" >
                </div>
                <br/>
                <br/>
                <div class="input-prepend">
