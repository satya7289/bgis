...
<div id="content">
	<div class="container">
	 ...
	 <a href="<?php echo $this->Html->url( array('controller'=> 'parents', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					<?php echo $this->Html->link(__('Delete'), array('action'=>'delete', $this->Form->value('Parents.id')), array('class'=>'btn btn-danger'), sprintf(__('Are you sure you want to delete @%s?'), $this->Form->value('Parents.id'))); ?>
				</div>
			</div>
		  ...
		  <?php echo $this->Form->create('Parents',array('enctype'=>"multipart/form-data"));?>
				<div class="form-horizontal">
					<fieldset class="inputs">
						<legend>Parent Page Information</legend>
			...
			<?php echo $this->Html->link(__('View Parent'), array('action'=>'index', $this->Form->value('Parents.id')), array('class'=>'btn btn-primary'));?>
		<a href="<?php echo $this->Html->url( array('controller'=> 'parents', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					</fieldset>
				</div>
			</div>
