<div class="widget widget-table action-table">
						<h3>
                            ...
                            <small>
                                ...
                                'format' => __('There are %current% Parent pages on this system.')
                                ));
								//pr($specs);
                                ?>
                            </small>
					...
					<div class="widget-content">
						...
						<table class="table table-striped table-bordered">
							<thead>
								<tr>
									<th width="40%"><?php echo "All Parent Pages";  ?></th>
        <th><?php echo $this->Html->link(__('New Page'), array('action' => 'add'),array( "class"=>"btn btn-primary" ,"style"=>"margin-left:220px;")); ?></th>
					...
					<?php
						...
						?>
                        		  <tr>
                    <td colspan="5" class="<?php echo $class;?>"><center><strong>Parent Pages Details</strong></center></td>
               ...
               <li><a href="<?php echo $this->Html->url(array('controller'=>'parents','action'=>'edit', $parent['Parents']['id'])); ?>"><i class="icon-fixed-width icon-thumbs-up"></i> Update</a></li>
                                            <li><a href="<?php echo $this->Html->url(array('controller'=>'parents','action'=>'delete', $parent['Parents']['id'])); ?>"><i class=" icon-fixed-width icon-trash"></i> Delete</a></li>
                                          </ul>
                                        </div>
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    <td><?php echo h($parent['Parents']['page_title']); ?>&nbsp;</td>
            <td><?php if($parent['Parents']['status'] == 1){ echo 'Active'; }else { echo 'inactive';} ?>&nbsp;&nbsp;&nbsp;</td>
                                    <td><?php echo h($parent['Parents']['created']); ?>&nbsp;</td>
                                  </tr>	
                                <?php endforeach; ?>
