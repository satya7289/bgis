...
<div id="content">
	<div class="container">
        <div class="section">
          ...
          <?php echo $this->Html->link(__('List Student Page'), array('action' => 'index'),array( "class"=>"btn btn-primary")); ?>
                </div>
            </div>
            ...
            <?php echo $this->Form->create('Student',array('enctype'=>"multipart/form-data"));?>
                <fieldset class="inputs">
                    <legend><?php __('Add Student Page'); ?></legend>
                      <br/>
                     <div class="input-prepend">
                    <span class="add-on"><i class="icon-book"></i>&nbsp; Page Title</span>
                      <input  name="data[Parent][page_title]" type="text" placeholder="">
                </div>
                <br/>
                  <br/>
                        <div class="input-prepend">
                    <span class="add-on"><i class="icon-book"></i>&nbsp; Banner Image</span>
                      <input  type="file"  name="data[Student][banner_image]" >
                </div>
                <br/>
                <br/>
                 <div class="input-prepend">
