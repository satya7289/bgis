...
<div id="content">
	...
	<a href="<?php echo $this->Html->url( array('controller'=> 'about', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					<?php echo $this->Html->link(__('Delete'), array('action'=>'delete', $this->Form->value('About.id')), array('class'=>'btn btn-danger'), sprintf(__('Are you sure you want to delete @%s?'), $this->Form->value('About.id'))); ?>
				</div>
			</div>
		  ...
		  <?php echo $this->Form->create('About',array('enctype'=>"multipart/form-data"));?>
				<div class="form-horizontal">
					<fieldset class="inputs">
						<legend>About Page Information</legend>
			...
			<?php echo $this->Html->link(__('View About'), array('action'=>'index', $this->Form->value('About.id')), array('class'=>'btn btn-primary'));?>
		<a href="<?php echo $this->Html->url( array('controller'=> 'about', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					</fieldset>
				</div>
			</div>
