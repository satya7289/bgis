...
<div id="content">
	...
	<a href="<?php echo $this->Html->url( array('controller'=> 'campus', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					<?php echo $this->Html->link(__('Delete'), array('action'=>'delete', $this->Form->value('Campus.id')), array('class'=>'btn btn-danger'), sprintf(__('Are you sure you want to delete @%s?'), $this->Form->value('Campus.id'))); ?>
				</div>
			</div>
			<div class="section-body" >
		  <?php echo $this->Form->create('Campus',array('enctype'=>"multipart/form-data"));?>
				<div class="form-horizontal">
					<fieldset class="inputs">
						<legend>Campus Page Information</legend>
			...
			<?php echo $this->Html->link(__('View Campus'), array('action'=>'index', $this->Form->value('Campus.id')), array('class'=>'btn btn-primary'));?>
