					...
					<fieldset class="inputs">
						...
						<div class="string control-group stringish" id="Group">
                            ...
                            <div class="string control-group stringish" id="Email">
								<?php echo $this->Form->input('login', array('label'=>array('text'=>__('Username'),'class'=>'control-label'),'size'=>'40', 'between'=>'<div class="controls">', 'after'=>'<span class="help-inline"></span></div>'));?>
							</div>
							<div class="string control-group stringish" id="Email">
