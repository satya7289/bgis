...
<div id="content">
	<div class="container">
	 ...
	 <a href="<?php echo $this->Html->url( array('controller'=> 'news', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					<?php echo $this->Html->link(__('Delete'), array('action'=>'delete', $this->Form->value('Event.id')), array('class'=>'btn btn-danger'), sprintf(__('Are you sure you want to delete @%s?'), $this->Form->value('Event.id'))); ?>
				</div>
			</div>
		  ...
		  <?php echo $this->Form->create('Event',array('enctype'=>"multipart/form-data"));?>
				<div class="form-horizontal">
					<fieldset class="inputs">
						<legend>News Page Information</legend>
			        <?php echo  $this->Form->input('id',array('type'=>'hidden','value' => $this -> params['pass'][0]));?>
						<div class="string control-group stringish" id="Group">
				            ...
				            <?php  echo $this->Form->input('news_type'); ?>
							</div>
                            <div class="string control-group stringish" id="Email">
				            <?php  echo $this->Form->input('news_heading'); ?>
							</div>
                            <div class="string control-group stringish" id="Email">
			    ...
			    <div class="string control-group stringish" id="Email">
				            <?php  echo $this->Form->input('url'); ?>
                             ...
                             <div class="string control-group stringish" id="Email">
		                    <?php echo $this->Form->input('news_description')?>
							</div>
			...
			<?php echo $this->Html->link(__('View News'), array('action'=>'index', $this->Form->value('Event.id')), array('class'=>'btn btn-primary'));?>
		<a href="<?php echo $this->Html->url( array('controller'=> 'news', 'action'=>'index')); ?>" class="btn btn-link">Cancel</a>
					</fieldset>
				</div>
			</div>
