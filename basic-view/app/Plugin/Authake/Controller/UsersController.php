...
class UsersController extends AuthakeAppController {
	...
	var $paginate = array('limit' => 10, 'conditions' =>array('User.id NOT IN (1,2,4)'), 'order' => array('User.login' => 'asc'));//var $scaffold;
	
	function beforeFilter(){
		parent::beforeFilter();
		$userArr = array('1','2','4');
		if(!in_array($this->Session->read('Authake.id'), $userArr)){
